...
export default function SignupPage() {
  ...
  const handleSocialSignup = (provider: string) => {
    ...
    console.log(`Social signup with ${provider} - requires Supabase configuration`);
  };
    ...
    <div className="min-h-screen bg-background transition-colors duration-300 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Join thousands of satisfied customers across the UAE</p>
        </div>
        ...
        <div className="bg-card rounded-2xl shadow-xl p-8 border border-border transition-colors duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground text-center">
              ...
              <a href="/terms" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors">Terms</a>
              {' '}and{' '}
              <a href="/privacy-policy" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors">Privacy Policy</a>
            </p>
          </form>
          ...
          <div className="mt-6 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl border border-emerald-200 dark:border-emerald-800 transition-colors duration-300">
            <p className="text-sm text-foreground text-center">
              <strong>Want to book quickly?</strong> You can book services without creating an account!
            </p>
            <Link to="/categories">
              <Button 
                variant="outline" 
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-muted-foreground">
            ...
            <Link to="/login" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
