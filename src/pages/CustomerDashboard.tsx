...
export default function CustomerDashboard() {
  ...
  const bookings = [
    ...
    },
    {
      ...
      address: "123 Main St, Dubai, UAE",
      image:
        "https://images.unsplash.com/photo-1744302570616-a450cd2191e7?w=400",
    },
  ];
          ...
          <TabsContent value='bookings'>
            <div className='space-y-4'>
              {bookings.map((booking) => (
                <div
                  key={booking.id}
                  className='bg-card rounded-xl shadow-sm p-6 border border-border hover:shadow-xl hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300'>
        ...
        <Dialog open={reviewModalOpen} onOpenChange={setReviewModalOpen}>
          <DialogContent className='w-[calc(100%-2rem)] max-w-lg mx-auto max-h-[90vh] overflow-y-auto'>
            <DialogHeader>
              ...
              <DialogDescription className='text-sm'>
                Share your experience with this service to help others make
                informed decisions.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className='space-y-4 sm:space-y-5 py-2 sm:py-4'>
              ...
              <div className='bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 rounded-lg p-3 sm:p-4'>
                <p className='text-xs sm:text-sm text-foreground'>
                  ...
                  encrypted and stored securely. We never store your CVV.
                </p>
              </div>
