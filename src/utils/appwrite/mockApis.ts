...
const mockTestimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment: 'Outstanding service! The AL-Kabir team transformed my villa. Every corner was spotless, and they used eco-friendly products which is important for my children.',
    customer_avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400',
  ...
  },
  {
    ...
    service_name: 'House Cleaning',
    rating: 5,
    comment: 'Best cleaning service in Dubai, hands down. Professional team, eco-friendly products, excellent results, and fair pricing.',
    customer_avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400',
  ...
  },
  {
    ...
    service_name: 'House Cleaning',
    rating: 5,
    comment: 'Excellent deep cleaning service! My apartment looks brand new. The team paid attention to every detail.',
    customer_avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Fixed our water heater quickly and professionally! The plumber arrived on time with all the necessary equipment.',
    customer_avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400',
  ...
  },
  {
    ...
    service_name: 'Plumbing',
    rating: 5,
    comment: 'Emergency service was excellent. They arrived within 30 minutes of my call and fixed the burst pipe immediately.',
    customer_avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400',
    created_at: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), // 1 week ago
    is_featured: true,
  }
];
