        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-foreground mb-4 md:mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
              <span className="inline-block">Professional Home & Office Services</span>{' '}
              <span className="inline-block bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-500 dark:from-emerald-400 dark:via-teal-400 dark:to-emerald-300 bg-clip-text text-transparent animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200" style={{
            ...
            <p className="text-base md:text-lg text-muted-foreground mb-6 md:mb-8 leading-relaxed">
              Trusted company-employed professionals for cleaning, repairs, plumbing, painting, and more. Quality guaranteed service delivered to your doorstep.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12 w-full lg:max-w-xl mx-auto lg:mx-0">
              <div className="text-center lg:text-left bg-card/50 dark:bg-card/30 rounded-xl p-3 md:p-4 border border-border/50">
                <div className="text-2xl md:text-3xl text-emerald-600 dark:text-emerald-400 mb-1">5K+</div>
                <div className="text-xs md:text-sm text-muted-foreground">Happy Customers</div>
              </div>
              <div className="text-center lg:text-left bg-card/50 dark:bg-card/30 rounded-xl p-3 md:p-4 border border-border/50">
                <div className="text-2xl md:text-3xl text-emerald-600 dark:text-emerald-400 mb-1">150+</div>
                <div className="text-xs md:text-sm text-muted-foreground">Expert Team</div>
              </div>
              <div className="text-center lg:text-left bg-card/50 dark:bg-card/30 rounded-xl p-3 md:p-4 border border-border/50">
                <div className="text-2xl md:text-3xl text-emerald-600 dark:text-emerald-400 mb-1">4.8</div>
          ...
          <div className="hidden lg:block relative">
            <div className="relative w-full h-[400px] lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                ...
                <p className="text-sm opacity-90">Trusted by thousands of customers across UAE</p>
              </div>
            </div>
            ...
            <div className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 max-w-xs">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Service Guarantee</div>
                  <div className="text-lg text-gray-900 dark:text-white">100% Satisfaction</div>
                </div>
              </div>
            </div>
          </div>
